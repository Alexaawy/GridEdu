...
class StudentPayslip(models.Model):
    ...
    def student_pay_fees(self):
        ...
        for rec in self:
            ...
            # Debugging using print statements / ADDed by Ayman Kilany
            print("Journal:", self.journal_id.display_name, "(ID:", self.journal_id.id, ")")
            print("Default Account:", self.journal_id.default_account_id.display_name, "(ID:",
            ...
            for line in rec.line_ids:
                ...
                # Debugging using print statements / ADDed by Ayman Kilany
                    print(
                        f"Fee Item Name: {line.name}, Assigned Account ID: {line.account_id.id if line.account_id else 'None'}")
