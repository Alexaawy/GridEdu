...
class SchoolStandard(models.Model):
    ...
    @api.constrains("standard_id", "division_id" , "class_room_id")
    def check_standard_unique(self):
        ...
        if self.env["school.standard"].search(
            [
                ...
                ("class_room_id", "=", self.class_room_id.id),
                ("id", "not in", self.ids),
            ]
        ):
    ...
    def name_get(self):
        ...
        return [
            (rec.id, rec.class_room_id.name + " " + "/ " + rec.standard_id.name + " " + "[" + rec.division_id.name + "]")
            for rec in self
        ]
